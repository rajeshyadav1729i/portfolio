...
const Education = () => {
  ...
  return (
    <section id="education" className="py-24 bg-slate-50 dark:bg-slate-900/50">
        ...
        >
          {education.map((item, index) => (
            ...
            >
              ...
              <div className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:shadow-md transition-shadow group-hover:border-blue-200 dark:group-hover:border-blue-800">
